...
function run_bazel_build() {
  ...
  bazel build --cxxopt="-fprofile-arcs" --cxxopt="-Wunreachable-code" --cxxopt="-ftest-coverage" --linkopt="-lgcov" --linkopt="--coverage" ${CMDLINE_OPTIONS} ${job_args} -- ${formatted_targets}
}
